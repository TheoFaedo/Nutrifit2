...
const ProfileSVG: FunctionComponent<Props> = (props) => {
    ...
    const primaryStroke = primary ? ('stroke-' + primary) : 'stroke-none';

    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 374 374" className='h-7'>
            ...
            <circle cx="187" cy="187" r="172" fill="none" stroke="black" stroke-miterlimit="10" stroke-width="30"/>
        </svg>
    );
}
