...
export const ConsumableQuantityCard: FunctionComponent<Props> = (props) => {
    ...
    return <div key={idCons} className={"bg-neutral-700 mt-2 rounded-lg py-2 px-4 flex justify-between items-center"}>
            ...
            <div className="flex items-center gap-6">
                ...
                <button className="rounded-full flex items-center justify-center h-10 w-10 p-2 gradient-bg text-3xl text-white" onClick={(handleRemoveConsumption)}>-</button>
            </div>
        </div>
}