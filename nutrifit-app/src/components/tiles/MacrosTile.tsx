...
const MacrosTile: FunctionComponent<Props> = ( { consumptionList } ) => {
    ...
    const carbsDif = nutritionalgoal.carbohydrates_goal.value-nutritionalSum.carbohydrates.value;
    const fatsDif = nutritionalgoal.fats_goal.value-nutritionalSum.fats.value;
    const proteinsDif = nutritionalgoal.proteins_goal.value-nutritionalSum.proteins.value;
        ...
        <div className='macros_tile'>
            ...
            <div className='flex justify-evenly items-center'>
                ...
                <div className='flex flex-col items-center w-28 mx-1'>
                    ...
                    <DoughnutChart className="h-24 w-24" label={'Fats'} color={'#CC57F5'} value={nutritionalSum.fats.value} goal={nutritionalgoal.fats_goal.value} />
                ...
                <div className='flex flex-col items-center w-28 mx-1'>
                    ...
                    <DoughnutChart className="h-24 w-24" label={'Proteins'} color={'#EEBD30'} value={nutritionalSum.proteins.value} goal={nutritionalgoal.proteins_goal.value} />
