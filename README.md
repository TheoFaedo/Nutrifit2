...
The application is hosted on [nutrifitapp.theofdo.fr](https://www.nutrifitapp.theofdo.fr), and a testing account has been set up for your convenience. You can log in using the following credentials: 
- Username: JohnDoe
- Password: johndoe20
